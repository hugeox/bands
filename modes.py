...
if __name__ == "__main__":
    ...
    for l in range(N):
        for k in range(N):
            ...
            for a in range(8-filling):
                for b in range(filling):
                    for a1 in range(8-filling):
                        for b1 in range(filling):
    ...
    np.save("h_mode_{}.npy".format(id),H_mode)
